...
(function ($) {
    /* Initialize function */
    $.fn.tablemanager2 = function (options = null) {
        /**
        ...
        if (options !== null) {
            ...
            **/
            ...
            if (
                ...
                // div num rows
                var numrowsDiv =
                    '<div id="for_numrows2" class="for_numrows2" style="display: inline;"><label for="numrows2">' +
                    translate(voc_show_rows) +
                    ': </label><select id="numrows2"></select></div>';
            ...
            **/
            if (pagination === true || Table.hasClass("tablePagination")) {
                ...
                var pagesDiv =
                    '<div id="pagesControllers2" class="pagesControllers2"></div>';
            ...
            **/
            if (
                ...
                var filterbyDiv =
                    '<div id="for_filter_by2" class="for_filter_by2" style="display: inline;"><label for="filter_by2">' +
                    translate(voc_filter_by) +
                    ': </label><select id="filter_by2"></select> <input id="filter_input2" type="text" placeholder="' +
                ...
                $("input#filter_input2").on("keyup", function () {
                    var val = $.trim($(this).val())
                        .replace(/ +/g, " ")
                        .toLowerCase();
                    var select_by = $("select#filter_by2").val();
            ...
            **/
            if (
                ...
                Heads.each(function (col) {
                    if (
                        $(this).data("tablemanager2") &&
                        $(this).data("tablemanager2").dateFormat !== undefined
                    ) {
                        var dateF = $(this).data("tablemanager2").dateFormat;
                        dateColumn.push(col);
        ...
        **/
        Heads.each(function (n) {
            ...
            var disable =
                $(this).data("tablemanager2") === "disable"
                    ? true
        ...
        **/
        function generatePaginationValues() {
            ...
            $(".pagecontroller-num2").eq(0).addClass("currentPage2");
        ...
        **/
        function appendPageControllers(nPages) {
            // reset div
            $("#pagesControllers2").html("");
            // First
            $("#pagesControllers2").append(
                $("<button>", {
                    value: "first",
                    text: "<<",
                    class: "pagecontroller2 pagecontroller-f2",
                })
            );
            // Previous
            $("#pagesControllers2").append(
                $("<button>", {
                    value: "prev",
                    text: "<",
                    class: "pagecontroller2 pagecontroller-p2",
                })
            );
            // Numbers
            for (i = 1; i <= nPages; i++) {
                $("#pagesControllers2").append(
                    $("<button>", {
                        value: i,
                        text: i,
                        class: "pagecontroller2 pagecontroller-num2",
                    })
                );
            }
            // Next
            $("#pagesControllers2").append(
                $("<button>", {
                    value: "next",
                    text: ">",
                    class: "pagecontroller2 pagecontroller-n2",
                })
            );
            // Last
            $("#pagesControllers2").append(
                $("<button>", {
                    value: "last",
                    text: ">>",
                    class: "pagecontroller2 pagecontroller-l2",
                })
            );
        }
        ...
        **/
        function pagecontrollersClick() {
            $(".pagecontroller2").on("click", function () {
                ...
                $(".pagecontroller-num2").removeClass("currentPage2");
                $(".pagecontroller-num2")
                    .eq(currentPage)
                    .addClass("currentPage2");
